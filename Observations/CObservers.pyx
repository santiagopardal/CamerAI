...
cdef class MovementDetectionObserver(Observer):
    cdef public object _neural_network, _frame_handler
...
cdef class DenoiserObserver(MovementDetectionObserver):
    """
