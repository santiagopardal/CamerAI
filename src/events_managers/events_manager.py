...
Subscription = TypedDict("Subscription", {"publisher": object, "subscriber": EventsSubscriber})
...
class EventsManager:
    ...
    def subscribe(self, subscriber: EventsSubscriber, event_type: str, publisher: object):
        ...
        if not registered:
            self._subscriptions[event_type].append({"publisher": publisher, "subscriber": subscriber})
    ...
    def notify(self, event_type: str, publisher: object, **event_data):
        ...
        for subscription in subscriptions:
            if subscription["publisher"] == publisher:
                ...
                subscriber.notify(event_type=event_type, publisher=publisher, **event_data)
