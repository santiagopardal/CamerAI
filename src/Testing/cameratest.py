...
from src.Observations.YOLO import YOLOv4Tiny
...
def show_video():
    cap = cv2.VideoCapture("rtsp://{}:{}@192.168.1.131:1113/videoMain".format(urllib.parse.quote(constants.USER), urllib.parse.quote(
        constants.PASSWORD)))
